...
//! 
//! See `Variable-length quantity` Wikipedia article https://en.wikipedia.org/wiki/Variable-length_quantity.
//! 
...
//! 
//! See `VARINT` discussion in journal article https://arxiv.org/abs/1401.6399.
//! 
//! See `Stream VByte` blog https://lemire.me/blog/2017/09/27/stream-vbyte-breaking-new-speed-records-for-integer-compression/.

/// `BYT_HDR_MSK` is a byte mask for the header of a variable integer encoding. 
/// 
/// A header of 1 indicates another byte exists in the variable length encoding.
/// 
